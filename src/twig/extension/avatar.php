...
class avatar extends phpbb_avatar
{
	...
	public function get_avatar(environment $environment, string $mode, array $row, ?string $alt, ?bool $ignore_config, ?bool $lazy, string $classes = '', bool $s_online = false): string
	{
		$alt = $alt ?? false;
